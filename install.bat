REM Installs Cynny's IntelliJ configs into your user configs.
@echo off
echo Installing Cynny IntelliJ configs...
...
echo.
echo Restart IntelliJ and/or AndroidStudio, go to preferences, and apply 'Cynny' or 'CynnyAndroid'.
exit /b
